...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/13 15:41:00 by abillote          #+#    #+#             */
/*   Updated: 2024/11/13 15:42:21 by abillote         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		//{
		//	if (ft_strncmp(command_list->splitted_input[i], /
		//tokens->content, ft_strlen(tokens->content))  /
		//&& ft_strncmp("function", /
		//tokens->type, ft_strlen(tokens->type)) == 0)
		//		command_list->function /
		//= ft_strdup(command_list->splitted_input[i]);
